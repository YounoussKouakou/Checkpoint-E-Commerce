...
//   // On gère la quantité par produit, donc un état par produit
//   // Par simplicité, on initialise toutes les quantités à 1
...
//                 onClick={() => alert(`Suppression de l’article ${item.name}`)}
//               >
